...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.Write("Enter the coach's name for Team 1: ");
        string team1CoachName = Console.ReadLine();

        Console.Write("Enter the coach's name for Team 2: ");
        ...
        for (int minute = 1; minute <= 90; minute++)
        {
            ...
            if (random.Next(25) < 1) //chance of a goal attempt
            {
            ...
            if (random.Next(35) < 0.3) //chance of a card
            {
